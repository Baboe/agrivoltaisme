    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="py-12 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { name: "Zonnepark De Groene Tafel", size: "85 hectares", region: "Gelderland" },
              { name: "Solar Park Limes", size: "120 hectares", region: "Noord-Holland" },
              { name: "Energiepark De Peel", size: "95 hectares", region: "Noord-Brabant" },
            ].map((park) => (
              <Card key={park.name} className="hover:shadow-md transition-shadow">
                ...
                <CardContent>
                  ...
                  <Button className="w-full mt-4 bg-green-600 hover:bg-green-700" asChild>
                    <Link href={`/solarparks/netherlands/${encodeURIComponent(park.name)}`}>
                      View Details
                    </Link>
                  </Button>
                </CardContent>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { name: "Schapenboerderij De Gouden Leeuw", flock: "300 sheep", breed: "Texel", region: "Zuid-Holland" },
              { name: "Landgoed De Groote Heide", flock: "450 sheep", breed: "Drents Heideschaap", region: "Drenthe" },
              { name: "Boerderij De Zonneweide", flock: "200 sheep", breed: "Friesian", region: "Friesland" },
            ].map((farm) => (
              <Card key={farm.name} className="hover:shadow-md transition-shadow">
                ...
                <CardContent>
                  ...
                  <Button className="w-full mt-4 bg-green-600 hover:bg-green-700" asChild>
                    <Link href={`/sheepfarms/netherlands/${encodeURIComponent(farm.name)}`}>
                      View Details
                    </Link>
                  </Button>
                </CardContent>
