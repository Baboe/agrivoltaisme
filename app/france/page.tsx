          ...
          {!stats.isMvp && (
            <div className="mt-6 p-4 bg-yellow-500/20 border border-yellow-400/30 rounded-lg">
              <p className="text-yellow-100">
                <strong>Coverage note:</strong> France is in Ombaa&apos;s broader dataset, but public directory coverage
                is not live yet. Request an assessment if you manage a site in France.
              </p>
            </div>
          )}
        </div>
      ...
      {!stats.isMvp && (
        <section className="py-12 bg-white">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl font-bold mb-4">Manage a site in France?</h2>
            <p className="text-gray-600 text-lg mb-8 max-w-2xl mx-auto">
              Ombaa has {stats.total} France records in the wider dataset. Request a grazing assessment if you want us
              to review a French site directly.
            </p>
      ...
      <section className="py-12 bg-green-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 text-green-100">
            While France is not yet part of the public directory, you can browse current coverage in the Netherlands and Belgium
          </p>
